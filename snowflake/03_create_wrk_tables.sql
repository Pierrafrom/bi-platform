...
CREATE TABLE IF NOT EXISTS WRK.CHAMBRE (
    ...
    WRK_STTS_CD             VARCHAR(3),        -- OK / REJ / ENC
    REJ_COD                 VARCHAR(20),       -- NULL_MANDATORY / WRONG_TYPE / etc
    REJ_DSC                 VARCHAR(500),
    BATCH_DT                DATE,
    EXEC_ID                 INTEGER,
...
CREATE TABLE IF NOT EXISTS WRK.MEDICAMENT (
...
CREATE TABLE IF NOT EXISTS WRK.PERSONNEL (
...
CREATE TABLE IF NOT EXISTS WRK.PATIENT (
...
CREATE TABLE IF NOT EXISTS WRK.CONSULTATION (
    ...
    UNIT_TEMP               VARCHAR(1),
    PATN_TEMP_C             DECIMAL(5,2),     -- Normalisée en °C
    TENSION_PATIENT         INTEGER,
    DSC_PATHO               VARCHAR(500),
    INDIC_DIABETE           BOOLEAN,
    DIBT_IND                BYTEINT,          -- Normalisé: 1/0
    INDIC_HOSPI             BOOLEAN,
    HOSP_IND                BYTEINT,          -- Normalisé: 1/0
...
CREATE TABLE IF NOT EXISTS WRK.TRAITEMENT (
...
CREATE TABLE IF NOT EXISTS WRK.HOSPITALISATION (
