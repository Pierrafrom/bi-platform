...
|---|---|---|---|---|---|
| `CHAMBRE_YYYYMMDD.txt` | `NO_CHAMBRE` | NUMBER | `NO_CHAMBRE` | INTEGER | ✅ PK |
| `CHAMBRE_YYYYMMDD.txt` | `NOM_CHAMBRE` | STRING(20) | `NOM_CHAMBRE` | VARCHAR(20) | ✅ |
...
| `CHAMBRE_YYYYMMDD.txt` | `PRIX_JOUR` | NUMBER | `PRIX_JOUR` | SMALLINT | ✅ |
| `CHAMBRE_YYYYMMDD.txt` | `DT_CREATION` | DATE | `DT_CREATION` | DATE | ✅ |

### MEDICAMENT — rechargement complet (full)

| Fichier source | Colonne source | Type source | Colonne STG | Type STG | Obligatoire |
|---|---|---|---|---|---|
| `MEDICAMENT_YYYYMMDD.txt` | `CD_MEDICAMENT` | STRING(10) | `CD_MEDICAMENT` | VARCHAR(10) | ✅ PK |
...
| `MEDICAMENT_YYYYMMDD.txt` | `CATG_MEDICAMENT` | STRING(100) | `CATG_MEDICAMENT` | VARCHAR(100) | ✅ PK |
| `MEDICAMENT_YYYYMMDD.txt` | `MARQUE_FABRI` | STRING(100) | `MARQUE_FABRI` | VARCHAR(100) | ✅ PK |
...
| Fichier source | Colonne source | Type source | Colonne STG | Type STG | Obligatoire |
|---|---|---|---|---|---|
| `PERSONNEL_YYYYMMDD.txt` | `ID_PERSONNEL` | NUMBER | `ID_PERSONNEL` | INTEGER | ✅ PK |
| `PERSONNEL_YYYYMMDD.txt` | `NOM_PERSONNEL` | STRING(100) | `NOM_PERSONNEL` | VARCHAR(100) | ✅ |
| `PERSONNEL_YYYYMMDD.txt` | `PRENOM_PERSONNEL` | STRING(100) | `PRENOM_PERSONNEL` | VARCHAR(100) | ✅ |
| `PERSONNEL_YYYYMMDD.txt` | `FONCTION_PERSONNEL` | STRING(50) | `FONCTION_PERSONNEL` | VARCHAR(50) | ✅ |
| `PERSONNEL_YYYYMMDD.txt` | `TS_DEBUT_ACTIVITE` | DATETIME | `TS_DEBUT_ACTIVITE` | TIMESTAMP(0) | ✅ |
...
| `PERSONNEL_YYYYMMDD.txt` | `TS_CREATION_PERSONNEL` | DATETIME | `TS_CREATION_PERSONNEL` | TIMESTAMP(0) | ✅ |
| `PERSONNEL_YYYYMMDD.txt` | `TS_MAJ_PERSONNEL` | DATETIME | `TS_MAJ_PERSONNEL` | TIMESTAMP(0) | ✅ |
| `PERSONNEL_YYYYMMDD.txt` | `CD_STATUT_PERSONNEL` | STRING(10) | `CD_STATUT_PERSONNEL` | VARCHAR(10) | ✅ |

### PATIENT — delta

| Fichier source | Colonne source | Type source | Colonne STG | Type STG | Obligatoire |
|---|---|---|---|---|---|
| `PATIENT_YYYYMMDD.txt` | `ID_PATIENT` | NUMBER | `ID_PATIENT` | INTEGER | ✅ PK |
| `PATIENT_YYYYMMDD.txt` | `NOM_PATIENT` | STRING(100) | `NOM_PATIENT` | VARCHAR(100) | ✅ |
| `PATIENT_YYYYMMDD.txt` | `PRENOM_PATIENT` | STRING(100) | `PRENOM_PATIENT` | VARCHAR(100) | ✅ |
...
| `PATIENT_YYYYMMDD.txt` | `TS_CREATION_PATIENT` | DATETIME | `TS_CREATION_PATIENT` | TIMESTAMP(0) | ✅ |
| `PATIENT_YYYYMMDD.txt` | `TS_MAJ_PATIENT` | DATETIME | `TS_MAJ_PATIENT` | TIMESTAMP(0) | ✅ |

### CONSULTATION — delta

| Fichier source | Colonne source | Type source | Colonne STG | Type STG | Obligatoire |
|---|---|---|---|---|---|
| `CONSULTATION_YYYYMMDD.txt` | `ID_CONSULT` | NUMBER | `ID_CONSULT` | INTEGER | ✅ PK |
| `CONSULTATION_YYYYMMDD.txt` | `ID_PERSONNEL` | NUMBER | `ID_PERSONNEL` | INTEGER | ✅ |
| `CONSULTATION_YYYYMMDD.txt` | `ID_PATIENT` | NUMBER | `ID_PATIENT` | INTEGER | ✅ |
| `CONSULTATION_YYYYMMDD.txt` | `TS_DEBUT_CONSULT` | DATETIME | `TS_DEBUT_CONSULT` | TIMESTAMP(0) | ✅ |
| `CONSULTATION_YYYYMMDD.txt` | `TS_FIN_CONSULT` | DATETIME | `TS_FIN_CONSULT` | TIMESTAMP(0) | ✅ |
| `CONSULTATION_YYYYMMDD.txt` | `POIDS_PATIENT` | NUMBER | `POIDS_PATIENT` | INTEGER | ✅ |
...
| Fichier source | Colonne source | Type source | Colonne STG | Type STG | Obligatoire |
|---|---|---|---|---|---|
| `TRAITEMENT_YYYYMMDD.txt` | `ID_TRAITEMENT` | NUMBER | `ID_TRAITEMENT` | INTEGER | ✅ PK |
| `TRAITEMENT_YYYYMMDD.txt` | `CD_MEDICAMENT` | NUMBER | `CD_MEDICAMENT` | INTEGER | ✅ |
| `TRAITEMENT_YYYYMMDD.txt` | `CATG_MEDICAMENT` | STRING(100) | `CATG_MEDICAMENT` | VARCHAR(100) | ✅ |
| `TRAITEMENT_YYYYMMDD.txt` | `MARQUE_FABRI` | STRING(100) | `MARQUE_FABRI` | VARCHAR(100) | ✅ |
| `TRAITEMENT_YYYYMMDD.txt` | `QTE_MEDICAMENT` | NUMBER | `QTE_MEDICAMENT` | SMALLINT | — |
| `TRAITEMENT_YYYYMMDD.txt` | `DSC_POSOLOGIE` | STRING(100) | `DSC_POSOLOGIE` | VARCHAR(100) | ✅ |
| `TRAITEMENT_YYYYMMDD.txt` | `ID_CONSULT` | NUMBER | `ID_CONSULT` | INTEGER | ✅ |
| `TRAITEMENT_YYYYMMDD.txt` | `TS_CREATION_TRAITEMENT` | DATETIME | `TS_CREATION_TRAITEMENT` | TIMESTAMP(0) | ✅ |

### HOSPITALISATION — delta

| Fichier source | Colonne source | Type source | Colonne STG | Type STG | Obligatoire |
|---|---|---|---|---|---|
| `HOSPITALISATION_YYYYMMDD.txt` | `ID_HOSPI` | NUMBER | `ID_HOSPI` | INTEGER | ✅ PK |
| `HOSPITALISATION_YYYYMMDD.txt` | `ID_CONSULT` | NUMBER | `ID_CONSULT` | INTEGER | ✅ |
| `HOSPITALISATION_YYYYMMDD.txt` | `NO_CHAMBRE` | NUMBER | `NO_CHAMBRE` | SMALLINT | ✅ |
| `HOSPITALISATION_YYYYMMDD.txt` | `TS_DEBUT_HOSPI` | DATETIME | `TS_DEBUT_HOSPI` | TIMESTAMP(0) | ✅ |
...
| `HOSPITALISATION_YYYYMMDD.txt` | `ID_PERSONNEL_RESP` | NUMBER | `ID_PERSONNEL_RESP` | INTEGER | ✅ |
